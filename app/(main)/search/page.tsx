...
export default function Navbar() {
  ...
  return (
    <div className="flex fixed left-0 top-0 z-50 h-screen select-none">
      ...
      <nav 
        className={`flex flex-col justify-between h-full bg-white border-r border-[#dbdbdb] px-3 pt-10 pb-6 font-sans text-[16px] text-[#262626] transition-all duration-300 ease-in-out z-20 ${
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-1">
            ...
            <button 
              ...
              className={`flex items-center gap-4 p-3 rounded-lg transition-all group w-full text-left ${
                isOpenSearch ? 'border border-[#dbdbdb] bg-[#fafafa] font-bold' : 'hover:bg-[#fafafa]'
              }`}
            >
              <svg className="w-6 h-6 stroke-[2] stroke-current min-w-[24px]" fill="none" viewBox="0 0 24 24">
      ...
      <div 
        className={`w-[397px] h-full bg-white border-r border-[#dbdbdb] rounded-r-2xl shadow-sm transition-all duration-300 ease-in-out px-6 pt-6 transform z-10 ${
