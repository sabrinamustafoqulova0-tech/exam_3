...
export default function ReelsPage() {
  ...
  if (!data || data.length === 0) {
    return (
      <div className="flex h-full w-full flex-col items-center justify-center bg-black text-gray-400">
        <div className="text-center p-6">
          <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-white/5 text-white">
            <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
            </svg>
          </div>
          <h3 className="text-lg font-bold text-white mb-1">No Reels Available</h3>
  ...
  return (
    <div className="h-full w-full overflow-y-scroll bg-black text-white snap-y snap-mandatory scrollbar-none flex flex-col items-center">
      {data.map((reel) => (
        <ReelCard
          key={reel.postId}
          reel={reel}
      ...
      <div className="relative flex h-[95vh] items-end justify-center gap-6 max-h-[850px] w-full max-w-[550px] px-4">
        ...
        <div className="flex flex-col items-center gap-6 pb-6 pointer-events-auto select-none">
          ...
          <div className="flex flex-col items-center gap-1 group">
            ...
            <span className="text-[12px] font-medium text-white select-none">{likeCount}</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-1 group">
            <button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-full transition duration-200 text-white hover:text-white/80 cursor-pointer active:scale-90"
            >
              <ChatBubbleOvalLeftIcon className="h-7 w-7 transition-transform group-hover:scale-105" />
            </button>
            <span className="text-[12px] font-medium text-white select-none">{comments.length}</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-1 group">
            <button
              ...
              className={`flex h-11 w-11 items-center justify-center rounded-full transition duration-200 cursor-pointer active:scale-90 ${
                isBookmarked ? "text-yellow-500" : "text-white hover:text-white/80"
              }`}
            >
              {isBookmarked ? (
            ...
            <span className="text-[10px] font-semibold text-white/50 select-none uppercase tracking-wider mt-0.5">Save</span>
          </div>
          ...
          <div className="relative group">
            <button
              ...
              className="flex h-11 w-11 items-center justify-center text-white hover:text-white/80 transition cursor-pointer active:scale-90"
            >
            ...
            {showMoreMenu && (
              <>
                ...
                ></div>
                <div className="absolute bottom-12 right-0 w-44 z-50 rounded-2xl bg-neutral-900/95 border border-white/10 p-2 text-sm text-white backdrop-blur-xl shadow-2xl animate-scale-up">
                  <button
                    onClick={() => {
                      setShowMoreMenu(false)
                      triggerToast("Reel reported successfully.")
                    }}
                    className="w-full text-left px-3 py-2 text-red-500 hover:bg-white/5 rounded-lg font-semibold transition cursor-pointer"
                  >
                    Report
                  </button>
                  <button
                    onClick={handleShare}
                    className="w-full text-left px-3 py-2 hover:bg-white/5 rounded-lg transition cursor-pointer"
                  >
                    Copy Link
                  </button>
                  <button
                  ...
                  <button
                    onClick={() => setShowMoreMenu(false)}
                    className="w-full text-left px-3 py-2 text-gray-400 hover:bg-white/5 rounded-lg transition cursor-pointer"
                  >
                    Cancel
                  </button>
                </div>
          ...
          <div className="mt-2 relative group p-0.5 bg-black border border-white/40 rounded-md overflow-hidden h-7 w-7 cursor-pointer hover:scale-105 transition duration-150">
            <img
              src={
                reel.userImage
                  ? `${API_IMAGE}${reel.userImage}`
